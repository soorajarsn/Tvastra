var parentContainer = document.getElementsByClassName('parent-container');
for(var i = 0; i < parentContainer.length; i++){
    var id = parentContainer[i].getAttribute('id');
    console.log(id);
    if(id == 'page0')
        parentContainer[i].classList.add('active-page');
}
var doctorCard = document.getElementsByClassName('doctor-container');
var l = doctorCard.length;
// for(var i = 0; i < l; i++){
//     doctorCard[i].addEventListener('click',function(){
//         const id = this.getAttribute('id');
//         console.log(id);
//         location.href = `/doctorDetail/?id=${id}`;
//     });
// }
...
pages.forEach(page=>{
    page.addEventListener('click',function(){
        ...
        setTimeout(function(){
            document.getElementById(`page${pageNumber-1}`).classList.add('active-page');
        },100);
...
// ==================================================================================
// var nextAvailableButtons = document.getElementsByClassName('next-available');
// for(var i = 0; i < nextAvailableButtons.length; i++){
//     nextAvailableButtons[i].addEventListener('click',function(){
//         var slotMainContainer = this.parentNode.parentNode.parentNode.parentNode.parentNode;
//         var activeCard = document.querySelector('.cards-container .slide-open')
//         var activeCardNumber = activeCard.classList[0];
//         var cards = slotMainContainer.querySelectorAll('card');
//         cards.forEach(function(card){
//             var number = card.classList[0];
//             if(number > activeCardNumber){
